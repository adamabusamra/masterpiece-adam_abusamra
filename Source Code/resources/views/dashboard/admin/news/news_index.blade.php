  ...
  <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    ...
    <div class="d-flex align-items-center flex-wrap mr-2">
      ...
      <div class="d-flex align-items-center" id="kt_subheader_search">
        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{ count($news) }} Total</span>
        <form class="ml-5">
...
<div class="card card-custom">
  <div class="card-header flex-wrap border-0 pt-6 pb-0">
    <div class="card-title">
      <h3 class="card-label">News Table
        <span class="d-block text-muted pt-2 font-size-sm">Datatable displaying all news</span></h3>
    </div>
  ...
  <div class="card-body">
    ...
    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
      <thead>
        <tr>
          <th title="News #1">Post</th>
          <th title="News #2">Description</th>
          <th title="News #3">tag</th>
          <th title="News #4">Created At</th>
          <th title="News #5">Actions</th>
        </tr>
      </thead>
      <tbody>
        @php
        ...
        <td>
          <span style="overflow: visible; position: relative; width: 130px;">
            ...
            <form class='d-inline' action="{{route('posts.destroy',$post->id)}}" method="POST"
              id="delete-post-form-{{$counter}}">
              @csrf
              @method('DELETE')
              <button class="btn btn-sm btn-default btn-text-primary btn-hover-danger btn-icon delete-post"
...
<script>
  deleteFunction = (id)=>{
  var form = document.getElementById(`delete-post-form-${id}`)
  Swal.fire({
  title: 'Are you sure?',
