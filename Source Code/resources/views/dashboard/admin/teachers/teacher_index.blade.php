...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
  <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    ...
    <div class="d-flex align-items-center flex-wrap mr-2">
      <!--begin::Title-->
      <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Teachers</h5>
      <!--end::Title-->
      <!--begin::Separator-->
      ...
      <div class="d-flex align-items-center" id="kt_subheader_search">
        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{ count($teachers) }} Total</span>
        <form class="ml-5">
...
<div class="card card-custom">
  <div class="card-header flex-wrap border-0 pt-6 pb-0">
    <div class="card-title">
      <h3 class="card-label">Teachers Table
        <span class="d-block text-muted pt-2 font-size-sm">Datatable displaying all teachers</span></h3>
    </div>
  ...
  <div class="card-body">
    ...
    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
      <thead>
        <tr>
          <th title="Field #1">Teacher</th>
          <th title="Field #2">Email</th>
          <th title="Field #3">title</th>
          <th title="Field #4">speciality</th>
        ...
        <td>
          <div class="d-flex align-items-center">
            <div class="symbol symbol-40 symbol-sm flex-shrink-0"> <img class=""
                src="{{ asset('teacher/images/'.$teacher->image) }}" alt="Teacher Image"> </div>
            <div class="ml-4">
        ...
        <td>
          <span style="overflow: visible; position: relative; width: 130px;">
            ...
            <form class='d-inline' action="{{route('teachers.destroy',$teacher->id)}}" method="POST"
              id="delete-teacher-form-{{$counter}}">
              @csrf
              @method('DELETE')
              <button class="btn btn-sm btn-default btn-text-primary btn-hover-danger btn-icon delete-teacher"
...
<script>
  deleteFunction = (id)=>{
  var form = document.getElementById(`delete-teacher-form-${id}`)
  Swal.fire({
  title: 'Are you sure?',
