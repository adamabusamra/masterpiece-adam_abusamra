      ...
      <div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
        ...
        <div class="row">
          <div class="offset-xxl-2 col-xxl-8">
            <form class="form" id="kt_form" action="{{route('teachers.store')}}" method="POST">
              @csrf
              <!--begin: Wizard Step 1-->
              ...
              <div class="pb-5" data-wizard-type="step-content">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-solid form-control-lg" name="title"
                    placeholder="Professional Title" value="{{old('title')}}"
...
<script src="{{ asset('assets/js/pages/custom/wizard/create-teacher-wizard.js')}}"></script>
@endsection