...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
  <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    ...
    <div class="d-flex align-items-center flex-wrap mr-2">
      <!--begin::Title-->
      <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Student</h5>
      <!--end::Title-->
      <!--begin::Separator-->
      ...
      <div class="d-flex align-items-center" id="kt_subheader_search">
        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{ $student->first_name }}
          ...
          <div class="wizard-step" data-wizard-type="step">
            <div class="wizard-wrapper">
              ...
              <div class="wizard-label">
                ...
                <div class="wizard-desc">Student's Field & Speciality</div>
              </div>
            </div>
          </div>
      ...
      <div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
        ...
        <div class="row">
          <div class="offset-xxl-2 col-xxl-8">
            <form class="form" id="kt_form" action="{{route('students.update',$student->id)}}" method="POST">
              @csrf
              @method('put')
              <!--begin: Wizard Step 1-->
              <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control form-control-solid form-control-lg" name="email"
                    placeholder="Email" value="{{ $student->email }}" {{ $errors->has('email') ? 'is-invalid' :'' }} />
                  ...
                  <div class="col-xl-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-solid form-control-lg" name="address1"
                        placeholder="Address Line 1" value="{{ $student->address1 }}"
                  ...
                  <div class="col-xl-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-solid form-control-lg" name="address2"
                        placeholder="Address Line 2" value="{{ $student->a }}"
                  ...
                  <div class="col-xl-6">
                    ...
                    <div class="form-group">
                      ...
                      <select name="country" class="form-control form-control-solid form-control-lg"
                        ...
                        <option value="{{$country}}" {{$student->country == $country ? 'selected' : '' }}>{{$country}}
                        </option>
                        @endforeach
                      </select>
                      @error('country')
                  ...
                  <div class="col-xl-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-solid form-control-lg" name="city"
                        placeholder="City" value="{{$student->city}}" {{ $errors->has('city') ? 'is-invalid' :'' }} />
              ...
              <div class="pb-5" data-wizard-type="step-content">
                ...
                <div class="form-group">
                  ...
                  <select name="field" class="form-control form-control-solid form-control-lg"
                    ...
                    <option value="{{$field->id}}" {{ $student->field_id == $field->id ? 'selected' : ''}}>
                      {{$field->name}}</option>
                    @endforeach
                    @endif
                  </select>
...
<script src="{{ asset('assets/js/pages/custom/wizard/edit-student-wizard.js')}}"></script>
<script>
