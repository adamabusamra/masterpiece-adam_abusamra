...
<div class="d-flex flex-row">
  ...
  <div class="flex-row-auto offcanvas-mobile w-350px w-xl-400px" id="kt_chat_aside">
    ...
    <div class="card card-custom">
      ...
      <div class="card-body">
        <!--begin:Users-->
        <div class="mt-7 scroll scroll-pull" id="student-list-place">
          <h4 class="mb-4">Students</h4>
          @foreach ($students as $student)
          <!--begin:User-->
          <div class="d-flex align-items-center justify-content-between mb-5 p-5 rounded shadow-sm student-card"
            id="{{$student->id}}" onclick="selectStudent(this.id)">
            <div class="d-flex align-items-center">
              <div class="symbol symbol-circle symbol-50 mr-3">
                <img alt="Pic" src="student/images/default-avatar.png" />
              </div>
              <div class="d-flex flex-column">
                <a class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">{{$student->first_name}}
                  {{$student->last_name}}</a>
                <span class="text-muted font-weight-bold font-size-sm">{{$student->field->name}}</span>
              </div>
            </div>
        ...
        <div class="mt-7 scroll scroll-pull" style="display: none" id="project-list-place">
          <button class="btn btn-primary mb-4" id="hide-project-list">Back to all students</button>
          ...
          <div class="d-flex align-items-center justify-content-between mb-5 p-5 rounded shadow-sm project-card"
            ...
            <div class=" d-flex align-items-center">
              ...
              <div class="d-flex flex-column">
                ...
                <span class="text-muted font-weight-bold font-size-sm">{{auth()->user()->speciality->name}}</span>
              </div>
            </div>
          </div>
          <!--end:User-->
    ...
    <div class="card card-custom">
      ...
      <div class="card-body">
        ...
        <div class="scroll scroll-pull" data-mobile-height="350">
          <!--begin::Messages-->
          <div class="messages" id="messages-place"></div>
          <!--end::Messages-->
        </div>
        <!--end::Scroll-->
      </div>
      ...
      <div class="card-footer align-items-center" id="action-area">
        <!--begin::Compose-->
        <div class="form-group row" id="competency-place">
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-5">
          <div>
            <button type="button" class="btn btn-primary btn-md text-uppercase font-weight-bold chat-send py-2 px-6"
              id="teacher-evaluate-project">Send</button>
          </div>
        </div>
        <!--begin::Compose-->
      </div>
...
<script src="{{asset('assets/js/pages/custom/chat/teacher-evaluate-project.js')}}"></script>
